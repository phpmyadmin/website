...
<div id="body">
    ...
    <py:if test="defined('announcement_commits_4_0')">
    <p>The following commits have been made on the 4.0 branch to fix this issue:</p>
    <ul>
    <py:for each="hash in announcement_commits_4_0().next()[1].strip().split('\n')">
    <li><a href="https://github.com/phpmyadmin/phpmyadmin/commit/${hash}">${hash}</a></li>
    </py:for>
    </ul>
    </py:if>
