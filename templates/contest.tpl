...
<p>
Packt Publishing sponsors this programming contest, offering six copies of the <a href="http://link.packtpub.com/4GvmBV">Mastering phpMyAdmin 3.4</a> book (two printed books and four e-books).
</p>
<h3>Rules</h3>
<ul>
 <li>For each item in the list of acceptable small feature requests, the first person to submit a correct patch implementing this feature to our <a href="http://sourceforge.net/tracker/?group_id=23067&amp;atid=377410">patch tracker</a> wins a book</li>
