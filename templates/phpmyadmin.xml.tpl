...
<py:for each="file in release.files"><py:if test="file.featured"><py:if test="file.ext == '.zip'">
	...
	<Program_Descriptions>
		<English>
			...
			<Char_Desc_250>phpMyAdmin is a free software tool written in PHP intended to handle the administration of MySQL over the World Wide Web. phpMyAdmin supports a wide range of operations with MySQL, providing intuitive user interface for most of them.</Char_Desc_250>
