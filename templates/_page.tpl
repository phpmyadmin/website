...
<!--! This is main page template used for all other pages. -->
 ...
 <body>
  ...
  <ul id="footer">
    <li>Copyright &copy; 2003 - 2008 <span class="vcard"><a class="url org fn" href="${server}${base_url}team.${file_ext}">phpMyAdmin devel team</a><a href="mailto:phpmyadmin-devel@lists.sf.net" class="email"></a></span></li>
